...
title: 反馈渠道
---
首先，请确定您的问题是否**一定**（指在阅读本文档站后，如[常见问题页面](/docs/FAQ)之后，仍然找不到解决方案的情况下）需要零协会协助。  
**如果您只是来寻找聊天QQ频道(群)的，请参考** [**加入周边社区或加入零协会**](/docs/main#join-community) 中关于QQ频道的信息。
...
### 通过QQ频道
请参考 [加入周边社区或加入零协会](/docs/main#join-community) 中关于QQ频道的信息。
