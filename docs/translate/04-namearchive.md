...
- 实际上，日韩中对但丁的称呼和脑叶中对主管的称呼是**一致的**，当时翻译作了**主管**；但我们希望区分这两者，因此寻求一个对“主管”的替代，这是我们为什么没有选择主管；
> 这并非是出于任何形式的切割目的——正相反，我们在翻译中的**任何**涉及到前作原文的位置都极其**尊重原译法**。
>
> 我们会在原文相同时使用前作的翻译原文，在原文不同时使用不和前作重复的译文。
>
> 另外，请**不要再将友商的翻译截图与我们的翻译搞混了**。我们暂不支持手机端。
...
> 在这个讨论过程中，(与这页的画风不同的是) 我们没有经历许多强权降临般的考据和论证 - 更多的是对原文的理解和感受，还有大部分人的喜好。
> 
